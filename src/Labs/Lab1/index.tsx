  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        How to make Steak in a Cast Iron Pan:
        <ol id="wd-your-favorite-recipe">
          <li>Pat steak dry and let rest for 30 minutes</li>
          <li>Season with salt and peper to your liking on each side</li>
          <li>Heat up cast iron pan on medium-high heat</li>
          <li>Apply avocado oil to the pan and spread it around</li>
          <li>
            When fully heated, place steak on the pan with the fat cap making
            contact
          </li>
          <li>After searing the edge/fat cap, put steak on the pan</li>
          <li>Allow it to cook for 4 minutes and flip</li>
          <li>
            Add in butter to the pan and baste the steak while it cooks for an
            additional 4 minutes
          </li>
          <li>Take steak out of the pan and let rest for 5 minutes</li>
          <li>Enjoy!</li>
        </ol>
